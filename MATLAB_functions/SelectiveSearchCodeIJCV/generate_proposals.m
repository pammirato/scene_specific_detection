function generate_proposals(scene_name)
% Generates selective search region proposals. 
% Code adapted from demo provided by authors of:
%
%   Selective Search for Object Recognition,
%   J.R.R. Uijlings, K.E.A. van de Sande, T. Gevers, A.W.M. Smeulders, IJCV 2013
%%
init; 
image_path = fullfile(ROHIT_BASE_PATH, scene_name, JPG_RGB);
save_path= fullfile(ROHIT_META_BASE_PATH, scene_name, '/region_proposals/');
...
for il=1:length(image_names)
  ...
  disp(cur_image_name);
  im = imread(fullfile(image_path, cur_image_name));
