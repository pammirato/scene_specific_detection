...
image_path = fullfile('/playpen/ammirato/Data/RohitData/', scene_name, 'jpg_rgb/');
save_path= fullfile('/playpen/ammirato/Data/RohitMetaData', scene_name, '/region_proposals/');
